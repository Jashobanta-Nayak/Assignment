...
public class ArrayListSynchronized {
	...
	public static void main(String[] args) {
		//ArrayList<String>sync=(ArrayList<String>) Collections.synchronizedList(new ArrayList<String>());
		// in order to synchronize the ArrayList the best practice is make use of List instead of ArrayList
